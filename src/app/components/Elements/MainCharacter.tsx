  ...
  return (
    <div className="grid grid-cols-2 w-[34rem]">
      <Character
        ...
        className="border-y border-l border-y-light-green border-l-light-green"
      ></Character>
      <Frame width="16rem">
        <div className="grid grid-cols-7 h-full border-y border-r border-y-light-green border-r-light-green">
