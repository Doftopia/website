  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:mx-8  box-border gap-3 xl:grid-cols-3 2xl:grid-cols-4">
      {(items as GroupedItems[]).map((item: GroupedItems, index: number) => (
        <div
          key={index}
          className="text-black dark:text-primary px-3 flex flex-col bg-[#cfc4ab] dark:bg-dark-3 pb-4 border-blue border sm:w-full lg:w-auto box-border hover:-translate-y-2 transition-all cursor-pointer hover:brightness-90"
        ...
        >
          <div className="flex justify-between pt-3 w-full">
            <div className="flex flex-col transition-all">
              ...
              <h3 className="text-sm text-[#796f5a] dark:text-secondary">
