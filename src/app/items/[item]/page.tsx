      ...
      <div className="xl:flex flex-row gap-4 px-8 bg-[#a7a18d]">
        <div className="mt-10 lg:w-full">
          {item.map((item: GroupedItems, index: number) => (
            <div
              key={index}
              className="bg-[#cfc4ab] text-black px-3 pb-2 rounded-sm border-blue border"
            >
              <div className="flex justify-between pt-3 pb-3 mb-4">
                <div className="flex flex-col transition-all">
                  <h2 className="font-bold cursor-pointer hover:text-gray-300">
                    {item.itemName}
                  </h2>
                  ...
                  <h3
                    className=" mb-5 text-gray-500 cursor-pointer hover:text-green"
              ...
              {item.characteristics.map(
                (charac: Characteristic, idx: number) => (
        ...
        <div className="flex flex-col mt-3 lg:mt-10 gap-3">
          ...
          <div>
            {mobs.length > 0 && (
              <div>
                <div className="flex flex-wrap border-blue bg-[#cfc4ab] border pt-2 pl-2 pb-2 pr-2">
                  {mobs.map((mob: GroupedMob) => (
                    <div className="flex flex-row cursor-pointer hover:font-bold hover:bg-green pr-4 rounded-lg transition-all w-fit">
                      <div
                        onClick={() => {
